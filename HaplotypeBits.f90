...
!  PUBLIC compareHaplotype, compareHaplotypeAllowMissing
  ...
  INTERFACE compareHaplotype
    MODULE PROCEDURE compareHaplotypeThreshold, compareHaplotypeExtrict
...
!!#############################################################################################################################################################################################################################
!  FUNCTION compareHaplotype2(hap1, hap2, miss, nSecs) result(c)
...
!    end do
!
!  END FUNCTION compareHaplotype2
